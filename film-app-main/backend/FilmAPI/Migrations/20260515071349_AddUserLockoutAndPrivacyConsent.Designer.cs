...
namespace FilmAPI.Migrations
{
    ...
    [Migration("20260515071349_AddUserLockoutAndPrivacyConsent")]
    partial class AddUserLockoutAndPrivacyConsent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilmAPI.Model.Film", b =>
                {
                    ...
                    b.Property<string>("LinguaOriginale")
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("FilmAPI.Model.User", b =>
                {
                    ...
                    b.Property<int?>("FilmPreferitoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmAPI.Model.User", b =>
                {
                    ...
                    b.HasOne("FilmAPI.Model.Film", "FilmPreferito")
                        .WithMany()
                        .HasForeignKey("FilmPreferitoId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("CinemaPreferito");

                    b.Navigation("FilmPreferito");
                });
